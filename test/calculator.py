...
# 幫忙間隔
def calculate_help_interval(main_skill_health_boost):
    ...
    print(f'{helper_bonus=}')
    print(f'{help_speed_s=}')
    print(f'{help_speed_m=}')
    ...
    print(f'{nature_boost=}')
    print(f'{health_boost=}')
...
calc_help_interval = calculate_help_interval(main_skill_health_boost)
